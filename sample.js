...
function roundsInfo() {
  ...
  descriptionBox.innerText =
    "See how fast you can correctly answer 10 questions.";
...
function countdownInfo() {
  // Adds the proper description
  descriptionBox.innerText =
    "See how many questions you can correctly answer in one minute.";
  // Formats the buttons so the selected button is visually different from the others
...
function casualInfo() {
  // Adds the proper description
  descriptionBox.innerText =
    "Keep answering questions forever and see your average time per round.";
  // Formats the buttons so the selected button is visually different from the others
